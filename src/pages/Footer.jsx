...
export default function Footer() {
  return (
    <>
      ...
      <footer className="flex w-full flex-col items-center justify-center  py-6 bg-gradient-to-b from-[#5524B7] to-[#380B60] text-white/70">
        {/* Logo SVG */}
        <svg
          width="157"
          height="40"
        ...
        >
          {/* [your logo SVG path remains unchanged] */}
        </svg>
